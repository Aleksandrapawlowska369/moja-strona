        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-center lg:items-start">
          ...
          <div className="lg:col-span-7 flex flex-col space-y-10">
            <div className="space-y-6">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl xl:text-[4rem] leading-[1.1] md:leading-[1.15] font-heading font-medium text-text-light">
            ...
            <div className="font-sans text-text-muted text-base md:text-lg leading-relaxed md:leading-loose space-y-6 max-w-2xl">
              <p>
            ...
            <div className="pt-2 space-y-8">
              <div className="flex items-start gap-4 text-sm text-text-muted bg-white/[0.02] border border-white/5 rounded-2xl p-5 w-fit">
                <svg className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                <span className="max-w-[300px]">Nagranie trwa około 45 minut. Możesz obejrzeć je od razu albo wybrać dogodny termin.</span>
              </div>

              <div className="flex flex-col sm:flex-row gap-4">
                <a 
                  href="#webinar-widget"
                  className="inline-flex justify-center items-center px-8 py-4 bg-primary text-white font-sans font-semibold rounded-none hover:bg-white hover:text-primary transition-colors duration-300 text-sm tracking-wider uppercase text-center"
                >
                  Wybierz sposób obejrzenia
                </a>
              </div>
            </div>
          </div>
