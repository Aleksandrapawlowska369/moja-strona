  ...
  return (
    <section className="py-20 md:py-32 bg-[#F8FAFC] border-t border-slate-200">
      <div className="container mx-auto px-6 max-w-4xl">
        <p className="text-sm md:text-base font-bold text-[#C29B57] uppercase tracking-widest mb-12 md:mb-16">
        ...
        <div className="pt-10 md:pt-12 border-t border-slate-200">
          <p className="text-lg md:text-xl text-[#1E293B] font-bold">
