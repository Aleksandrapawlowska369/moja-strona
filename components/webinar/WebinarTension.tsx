  ...
  return (
    <section className="relative py-24 lg:py-32 bg-[#F8FAFC] overflow-hidden">
      <div className="container mx-auto px-5 md:px-8 max-w-4xl relative z-10">
        ...
        {/* 5 Situations - Editorial List */}
        <div className="mt-16 md:mt-20">
          <div className="space-y-8 md:space-y-10 pl-2 md:pl-6 max-w-3xl border-l-2 border-transparent">
        ...
        {/* Closing Emphasis - Standalone Editorial Bridge */}
        <div className="mt-20 md:mt-28 max-w-3xl pl-2 md:pl-6">
          <p className="text-2xl md:text-[1.75rem] font-heading font-medium text-[#1E293B] leading-snug">
