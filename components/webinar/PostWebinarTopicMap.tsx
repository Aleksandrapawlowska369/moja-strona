export function PostWebinarTopicMap() {
  return (
    <section className="py-20 md:py-32 bg-white">
      <div className="container mx-auto px-6 max-w-5xl">
        <h2 className="text-3xl md:text-5xl lg:text-6xl font-medium text-[#1E293B] mb-16 md:mb-24 leading-[1.15] max-w-4xl font-heading">
          Tożsamość to więcej niż sposób myślenia. Dlatego po drodze przyglądamy się temu, co dziś wpływa na Twój sposób czucia, reagowania, wybierania i działania.
        </h2>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-20 mb-16 md:mb-20">
          {/* TO, CO DZIAŁA POD POWIERZCHNIĄ */}
          <div className="border-t border-slate-200 pt-8 md:pt-10 pr-0 md:pr-8">
        ...
        <div className="pt-12 md:pt-16 border-t border-slate-200">
          <p className="text-xl md:text-2xl font-medium text-[#1E293B] leading-[1.6] max-w-4xl">
            Nie są to osobne tematy, które raz „zaliczasz” i zamykasz. Do części z nich wracamy w różnych momentach procesu, bo wraz z doświadczeniem możesz zobaczyć w nich coś, czego wcześniej jeszcze nie było widać.
          </p>
        </div>
      </div>
    </section>
